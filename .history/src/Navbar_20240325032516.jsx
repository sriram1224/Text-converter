  ...
  return (
    <nav className="relative px-4 py-4 flex justify-between items-center bg-white">
      ...
      <ul className={`lg:flex lg:mx-auto lg:flex lg:items-center lg:w-auto lg:space-x-6 ${isMenuOpen ? '' : 'hidden'}`}>
        ...
        <li>
          <Link to="/services" className="text-sm text-gray-400 hover:text-gray-500">
            Services
          </Link>
        </li>
        <li>
          <Link to="/pricing" className="text-sm text-gray-400 hover:text-gray-500">
            Pricing
          </Link>
        </li>
        <li>
          <Link to="/contact" className="text-sm text-gray-400 hover:text-gray-500">
            Contact
          </Link>
        </li>
      </ul>

      <label className="inline-flex items-center cursor-pointer lg:ml-auto lg:mr-3">
